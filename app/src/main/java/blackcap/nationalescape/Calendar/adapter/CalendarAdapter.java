package blackcap.nationalescape.Calendar.adapter;
...
import blackcap.nationalescape.Calendar.data.Day;
import blackcap.nationalescape.Calendar.data.Month;
import blackcap.nationalescape.Calendar.data.WeekManager;
import blackcap.nationalescape.Calendar.holder.MonthHolder;
...
public class CalendarAdapter extends RecyclerView.Adapter<MonthHolder> {
    ...
    private void setLabel(MonthHolder holder, Month m) {
        ...
        holder.label_month.setText(String.format("%4s.%2s",m.year, mMonthLabels.get(m.value - 1)));
        holder.label_month.setGravity(Gravity.CENTER);
    }
