package blackcap.nationalescape.Calendar.view;
...
import blackcap.nationalescape.Calendar.adapter.CalendarAdapter;
...
//        a.recycle();
    ...
    private void getAttrs(AttributeSet attrs, int defStyle) {
        ...
        calendarAttrs.weekdayHeight = 140;
...
//        if (TypedValue.TYPE_REFERENCE == a.getType(R.styleable.CalendarView_weekdayNameBackgroundColor)) {
        ...
        calendarAttrs.monthDividerSize = (int) a.getDimension(R.styleable.CalendarView_monthDividerSize, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, (float) 1, displayMetrics));
    ...
    public void setToday(int day, int month, int year){
        mCalendarAdapter.setToday(day, month, year);
    }
    ...
    public class Attributes {
        ...
        public int monthDividerSize = 20;

        public int eventCircleColor = 0;
    }
}