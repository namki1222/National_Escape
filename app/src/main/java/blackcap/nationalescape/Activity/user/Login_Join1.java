...
public class Login_Join1 extends AppCompatActivity {
    ImageView Back;
    ...
    public void Push_Sms(){
        if (Edit_Phone.getText().toString().length() == 11 && Edit_Phone.getText().toString().substring(0, 3).equals("010")) {
            ...
            if (result.equals("not exist")) {
                ...
                Toast.makeText(Login_Join1.this, "인증번호가 전송되었습니다", Toast.LENGTH_SHORT).show();
                ...
                cerfi_flag = false;
                Toast.makeText(Login_Join1.this, "이미 가입된 번호가 있습니다", Toast.LENGTH_SHORT).show();
            }
            else {
                cerfi_flag = false;
                Toast.makeText(Login_Join1.this, "잠시 후 다시 시도해주세요", Toast.LENGTH_SHORT).show();
            }
        } else {
            cerfi_flag = false;
            Toast.makeText(Login_Join1.this, "정확한 휴대전화번호를 입력해 주세요", Toast.LENGTH_SHORT).show();
        }
    }
    public void setCerti(){
        Img_Certi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(cerfi_flag == true){
                    Toast.makeText(Login_Join1.this, "이미 인증번호를 전송했습니다", Toast.LENGTH_SHORT).show();
                }
                else{
                    Push_Sms();
                }
    ...
    public void setCertiCheck(){
        Img_CertiCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(cerfi_flag == false){
                    Toast.makeText(Login_Join1.this, "인증 번호를 전송해주세요", Toast.LENGTH_SHORT).show();
                }
                else{
                    if(Edit_Certi.getText().toString() != null){
                        if(certi_num == Integer.parseInt(Edit_Certi.getText().toString())){
                            succed_flag = true;
                            Toast.makeText(Login_Join1.this, "인증이 완료되었습니다", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(Login_Join1.this, "인증번호를 입력해주세요", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    public void setBtnNext() {
        Img_Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(succed_flag == true){
                    Intent intent = new Intent(Login_Join1.this, Login_Join2.class);
                    ...
                    Toast.makeText(Login_Join1.this, "인증을 완료해주세요", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
