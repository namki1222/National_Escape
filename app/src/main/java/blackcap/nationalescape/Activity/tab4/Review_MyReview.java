    ...
    public class Async extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                str_result = http.HttpClient("Web_Escape", "MyReview_Search.jsp", User_Pk, "asc");
                str_result_desc = http.HttpClient("Web_Escape", "MyReview_Search.jsp", User_Pk, "desc");
                str_result_review = http.HttpClient("Web_Escape", "MyReview_Search.jsp", User_Pk, "review");
        ...
        protected void onPostExecute(String result) {
            ...
            for (int i = 0; i < parseredData.length; i++) {
                ...
                review_models.add(new Review_Log_Model(Review_MyReview.this, company_name, theme_name, grade, content, level, status, time, hint));
            }
            //리스트 뷰 세로 방향으로
            ...
            for (int i = 0; i < parseredData_desc.length; i++) {
                ...
                review_models_desc.add(new Review_Log_Model(Review_MyReview.this, company_name, theme_name, grade, content, level, status, time, hint));
            }
            //리스트 뷰 세로 방향으로
            LinearLayoutManager layoutManager1 = new LinearLayoutManager(Review_MyReview.this);
            layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
            layoutManager.scrollToPosition(0);

            //베스트 무료체험 어댑터 셋팅
            reviewSearch_adapter_desc = new Tab4_ReviewLog_Adapter(Review_MyReview.this, review_models_desc);
            ...
            for (int i = 0; i < parseredData_review.length; i++) {
                ...
                review_models_review.add(new Review_Log_Model(Review_MyReview.this, company_name, theme_name, grade, content, level, status, time, hint));
            }
            //리스트 뷰 세로 방향으로
            LinearLayoutManager layoutManager2 = new LinearLayoutManager(Review_MyReview.this);
            layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
            layoutManager.scrollToPosition(0);

            //베스트 무료체험 어댑터 셋팅
            reviewSearch_adapter_review = new Tab4_ReviewLog_Adapter(Review_MyReview.this, review_models_review);
