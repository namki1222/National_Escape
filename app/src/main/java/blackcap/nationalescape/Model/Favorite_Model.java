...
public class Favorite_Model {
    ...
    public Favorite_Model(android.app.Activity activity, String company_pk, String owner_pk, String title, String intro, String grade_avg, String recommend_count, String address, String distance){
